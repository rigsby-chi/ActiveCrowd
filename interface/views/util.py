  ...
  try:
    if os.path.exists('project/' + projectName + '/_mturk.question'):
      with open('project/' + projectName + '/_mturk.question') as QFile:
        ...
        QDict['QuestionTitle'] = lines.split("<Title>")[1].split("</Title>")[0]
        QDict['QuestionOverview'] = lines.split("</Title>")[1].split("<FormattedContent><![CDATA[")[1].split("]]></FormattedContent>")[0]
        QDict['DisplayName'] = lines.split("<DisplayName>")[1].split("</DisplayName>")[0]
        QDict['QuestionContent'] = lines.split("<QuestionContent>")[1].split("<FormattedContent><![CDATA[")[1].split("]]></FormattedContent>")[0]
        ...
        if TempAnswerType == "SelectionAnswer":
          ...
          Selections = lines.split("<Selections>")[1].split("</Selections>")[0]
